...
try:
    print "\t                 #############################"
    print "\t                 #  WE Are SL Cyber Army     #"
    print "\t                 #     Leakedforums.com      #"
    print "\t                 #        By AE Dev          #"
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf']
    ...
    try:
        site = raw_input("Which Web Site URL?: ")
        site = site.replace("http://","")
        print ("\tChecking website " + site + "...")
        conn = httplib.HTTPConnection(site)
        conn.connect()
        print "\t[$] Yes... Server is Online.Please Wait.."
    ...
    if code==1:
        ...
        raw_input("[/] Mission Completed; Press Enter to Exit!")
